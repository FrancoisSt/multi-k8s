...
kubectl set image deployments/client-deployment client=nawu/multi-client:$SHA
kubectl set image deployments/server-deployment server=nawu/multi-server:$SHA
kubectl set image deployments/worker-deployment worker=nawu/multi-worker:$SHA